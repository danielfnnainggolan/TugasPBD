...
<body>
  ...
  <div id="test">
    ...
    <div class="list-group">
      ...
      if($tipe_user == "user") { echo '<a href="'.base_url().'page/profil_user" class="list-group-item">Profil User';} elseif($tipe_user == "admin"){echo '<a href="'.base_url().'page/data_user" class="list-group-item">Data User';} elseif($tipe_user == "operator"){echo '<a href="'.base_url().'page/data_markers" class="list-group-item">Data Markers';}?></h2></a>
  ...
  <div class="container">
    ...
    <!-- Form Name -->
    <legend><center><h2><b>WEB GIS</b></h2></center></legend><br>
	    <div class="row">
