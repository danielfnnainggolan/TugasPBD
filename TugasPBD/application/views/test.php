            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $users->tipe_user?></td>
                        <td>
                            <a href="#editUserModal" class="edit" data-toggle="modal" onclick="getData('<?php echo $users->id_user?>',  '<?php echo $users->username?>', '<?php echo $users->password?>', '<?php echo $users->tipe_user?>')"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
			...
			<div class="modal-content">
				<form action="<?=base_url()?>index.php/user/addUser" method="POST">
					...
					<div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>tipe_user</label>
							 <select id="cars" class="form-control" name="u_tipe_user">
			...
			<div class="modal-content">
				<form action="<?=base_url()?>index.php/user/updateUser" method="POST">
					...
					<div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>tipe_user</label>
							<select id="cars" class="form-control" name="u_tipe_user" id="tipe_user_User">
								<option value="admin">Admin</option>
								<option value="operator">Operator</option>
								<option value="regular">Regular</option>
							</select>
...
<script>
    function getData(id, username, pass, tipe_user){
        ...
        document.getElementById("tipe_user_User").value = tipe_user;
    }
</script>
