        ...
        <div class="card-body">
          <table id="example2" class="table table-bordered table-hover">
            ...
            <tr>
              ...
              <td></td>
              <td> 4</td>
              <td width="90px"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></td>
            </tr>
          <?php endforeach;?>
        </tbody>
          </table>
